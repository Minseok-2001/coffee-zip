...
INSERT INTO user (provider, provider_id, email, nickname, profile_image, created_at)
VALUES ('google', 'test-google-id-1', 'test@example.com', '커피러버', NULL, NOW());

INSERT INTO recipe (user_id, title, description, coffee_bean, origin, roast_level, grinder, grind_size,
