...
INSERT INTO users (provider, provider_id, email, nickname, profile_image, created_at)
VALUES ('google', 'test-google-id-1', 'test@example.com', '커피러버', NULL, NOW());

INSERT INTO recipes (user_id, title, description, coffee_bean, origin, roast_level, grinder, grind_size,
...
INSERT INTO recipe_steps (recipe_id, step_order, label, duration, water_amount)
VALUES (1, 1, '뜸들이기', 45, 30),
       (1, 2, '1차 추출', 30, 80),
       (1, 3, '2차 추출', 30, 80),
       (1, 4, '3차 추출', 30, 60);

INSERT INTO recipe_tags (recipe_id, tag) VALUES (1, '핸드드립'), (1, '에티오피아');
